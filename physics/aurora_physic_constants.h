...
{
public:
    static constexpr Scalar gravity = 9.81*10; // m.s-2, Acceleration of the gravity
    ...
    static constexpr Scalar kineticCoef2 = 100.0; // Energy of a mass moving througth a transition
